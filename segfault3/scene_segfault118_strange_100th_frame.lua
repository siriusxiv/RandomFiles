...
function getCameraPosition(frame)
    ...
    --return {-160, -160,-160}
    if(frame<80) then
        return {200, 200*math.sin(2*frame/160*2*math.pi), 200*math.cos(2*frame/160*2*math.pi)} --turning
    else
        frame = frame-80;
        return {200-frame*2*200/80, frame*2*200/80, 200-frame*2*200/80}
    end
end
